...
| 집중 기능 개발            | 9/14(토)~9/15(일)               | 카카오 지도 메인, 디테일 페이지 노출 및<br/> 로그인/회원가입 페이지 생성                         | 김민규 프로젝트 세팅                            |
| 집중 기능 개발            | 9/16(월)~9/18(수)               | API(카카오 지도, 축제 데이터, 유튜브) 활용하여 각 페이지<br/> api기능 구현 완료 및 마이 페이지 구현(저장한 목록만 노출)                           | 최원장 튜터님의 코드리뷰<br/> 바탕으로 리팩토링 |
| 집중 디자인 개발 | 9/18(수)~9/19(목) | 스타일 적용 및 디테일 작업                                | 각 페이지, 지도 마커, 마커 윈도우인포 디자인 집중 개발                                 |
